...
class OtherStoriesAgent(RetailerAgent):
    RETAILER_NAME = "& Other Stories"
    ...
    async def search(
        ...
        category_paths = {
            "tops": "/en_eur/clothing/tops",
            "dresses": "/en_eur/clothing/dresses",
            "bottoms": "/en_eur/clothing/trousers",
            "outerwear": "/en_eur/clothing/jackets-and-coats",
        }
        path = category_paths.get(category, "/en_eur/clothing")
